...
void drone_loop() {
  ...
  double AcXD = AcX/32768.0;
  double AcYD = AcY/32768.0;
  double AcZD = AcZ/32768.0;
  double GyXD = GyX/32768.0;
  double GyYD = GyY/32768.0;
  double GyZD = GyZ/32768.0;
...
//  BalZ += ResZ;
  ...
  const int NUM_X = 6;
  const int NUM_Y = 3;
  double x[NUM_X] = {AcXD, AcYD, AcZD, GyXD, GyYD, GyZD};
  double y[NUM_Y] = {0,};
  
  dnn_predict(x, NUM_X, y, NUM_Y);
